...
class Student:
    ...
    def __init__(self,root):
       ...
       #pb.studentData()
       def iExit():
              iExit=tkinter.messagebox.askyesno(" student dbms","conform if you want to exit")
              if iExit>0:
                     root.destroy()
                     return
       def clearData():
      ...
      # pb.studentData()             
       ...
       self.lblTit=Label(TitFrame,font=('arial',47,'bold'),text="Students Database Managment System",bg="red",fg="black")
       self.lblTit.grid()

       self.lblTit=Label(TitFrame,font=('arial',25,'bold'),text="LOVELY PROFESSIONAL  UNIVERSITY",bg="red",fg="black")
       self.lblTit.grid()
